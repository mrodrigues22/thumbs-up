...
namespace ThumbsUpApi.Migrations
{
    ...
    [Migration("20251201224343_AddProcessedWebhookEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThumbsUpApi.Models.ProcessedWebhookEvent", b =>
                {
            ...
            modelBuilder.Entity("ThumbsUpApi.Models.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThumbsUpApi.Models.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThumbsUpApi.Models.Subscription", b =>
                {
                    b.HasOne("ThumbsUpApi.Models.ApplicationUser", "User")
                        .WithOne("Subscription")
                        .HasForeignKey("ThumbsUpApi.Models.Subscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ThumbsUpApi.Models.Transaction", b =>
                {
                    b.HasOne("ThumbsUpApi.Models.Subscription", "Subscription")
